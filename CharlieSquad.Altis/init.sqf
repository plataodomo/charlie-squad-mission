...
if (isNil "DYN_fnc_boostOpforAwareness") then {
    ...
    // Data link OFF — previous "data link ON" values become the new baseline
    ...
    // Data link ON — bumped to 75%
    missionNamespace setVariable ["DYN_OPFOR_dl_spotDistance",   0.75, true];
    missionNamespace setVariable ["DYN_OPFOR_dl_spotTime",       0.65, true];
    ...
    missionNamespace setVariable ["DYN_OPFOR_dl_aimingSpeed",    0.65, true];
